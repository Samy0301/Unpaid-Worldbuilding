"""Gestion de personajes organizados por categoria"""
...
class PersonajesView(ctk.CTkFrame, DialogMixin):
    ...
    def _cargar_categoria(self, frame, categoria):
        ...
        if not personajes:
            ...
            ctk.CTkLabel(
                empty, text=f"No hay personajes {categoria}s aun",
        ...
        for i, (pid, nombre, foto) in enumerate(personajes):
            card = ctk.CTkFrame(
                inner, corner_radius=15, width=220, height=300,
